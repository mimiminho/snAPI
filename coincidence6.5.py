...
if __name__ == "__main__":
    ...
    while True: 
        ...
        plt.clf()
        plt.plot(times, counts[0], 'r-', linewidth=2.0, label='sync')
        plt.plot(times, counts[1], 'g-', linewidth=2.0, label='chan1')
        plt.plot(times, counts[3], 'b-', linewidth=2.0, label='chan3')
        plt.plot(times, counts[coincidenceAll], 'c-', linewidth=2.0, label='coincidenceAll')
        plt.plot(times, counts[coincidenceOnce], 'm-', linewidth=2.0, label='coincidenceOnce')
