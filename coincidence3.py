...
if __name__ == "__main__":
    ...
    while True:
        ...
        # Calculate the average coincidence counts per second
        avg_coincidence_all = sum(counts[coincidenceAll]) / 10.0  # 10-second measurement
        avg_coincidence_once = sum(counts[coincidenceOnce]) / 10.0  # 10-second measurement
