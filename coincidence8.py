...
if __name__ == "__main__":
    ...
    while True:
        ...
        plt.clf()
        plt.scatter(times, counts[0], label='sync')
        plt.scatter(times, counts[1], label='chan1')
        plt.scatter(times, counts[3], label='chan3')
        plt.scatter(times, counts[coincidenceAll], label='coincidenceAll')
        plt.scatter(times, counts[coincidenceOnce], label='coincidenceOnce')
